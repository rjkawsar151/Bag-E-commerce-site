...
export const ADMIN_PASSWORD = "admin"; // Deprecated but kept for compatibility reference if needed

export const INITIAL_SITE_CONFIG: SiteConfig = {
    headerTitle: "Velvet & Vogue",
    logo: "", 
    footerText: "Defining modern elegance, one accessory at a time.",
    showMarquee: true, // This toggles the Product Marquee on Home
    showTopBar: true, // This toggles the Header Coupon Marquee
